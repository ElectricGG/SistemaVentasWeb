...
import { MatTableDataSource } from "@angular/material/table"; //trabajar con tablas de material
...
export class VentaComponent implements OnInit{
  ...
  columnsTabla: string[]= ["producto", "cantidad", "precio", "total", "accion"]; //define las columnas
  datosDetalleVenta = new MatTableDataSource(this.listaProductosParaVenta);

  retornarProductosPorElFiltro(busqueda:any):Producto[]{
